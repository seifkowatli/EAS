...
namespace ClusteringKMeans
{
    class KMeans
    {
        ...
        static public List<Cluster> ShowClustered(double[][] data, int[] clustering, int numClusters, int decimals)
        {
            ...
            for (int k = 0; k < numClusters; ++k)
            {
                ...
                Temp2.lab = Math.Round(lab / Temp2.ClusterList.Count,2);
                Temp2.Midterm = Math.Round(mid / Temp2.ClusterList.Count,2);
                Temp2.Final = Math.Round(Final / Temp2.ClusterList.Count,2);
